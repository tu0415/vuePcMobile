	...
	<div class="list">
		...
		<div class="table" v-loading="loadingTable">
			<el-table :data="tableData" style="width: 100%">
				...
				<el-table-column v-if="type == '1'" label="助力者" align="left" width="150">
					<template slot-scope="scope">
				...
				<el-table-column align="center" label="助力数">
					<template slot-scope="scope">
						<div v-if="scope.row.msgContent"><span class="blue">{{ scope.row.msgContent }}</span>知力</div>
					</template>
				</el-table-column>
