<template>
  <div class="dialog" v-show="showMask" >
    <div class="dialog-container">
      <div class="dialog-title">解绑确认</div>
      <div class="content">
        <div class="loginContent">
          ...
          <div class="loginBtnBox">
            <a href="javascript:;" class="loginBtn" @click="untie">确认解绑</a>
          </div>
        </div>
      </div>
  ...
  export default {
    ...
    methods:{
      ...
      untie(){
        ...
        indexApi.untieYoyowAccount({
          mobile: this.phone,
          code: this.code,
          userId: this.userId
        }).then(d => {
          if (d.code == '0') {
            this.$showSuccessMessage('解绑成功!');
            this.$emit('updateUntie');
            this.showMask = false;
            this.code = '';
          } else {
            this.$showErrorMessage(d.reason)
